...
| `/code-review` | Discovery | Multi-agent audit of existing code. Produces findings report. Feed output into `/intake`. |
...
src/features/<f>/__tests__/         ← Test skeletons (created by /plan)
