...
>
> Run `/intake` and pass this report — it will classify each finding, group related ones, assess risk and priority, and produce CR items ready for the process.
>
> Example: `/intake specs/reviews/<scope>-<date>.md`
>
> Or describe the most critical finding directly: `/intake "critical: tenant data exposed in <endpoint>"`
...
If the scope is broad (full codebase or full feature), offer to save the report:
